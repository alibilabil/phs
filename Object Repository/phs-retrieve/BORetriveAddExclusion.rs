...
<WebServiceRequestEntity>
  ...
  &quot;charset&quot;: &quot;UTF-8&quot;
   ...
   <variables>
      <defaultValue>findTestData('phs-retrieve/BORetriveAddExclusion').getValue(1, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('phs-retrieve/BORetriveAddExclusion').getValue(2, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('phs-retrieve/BORetriveAddExclusion').getValue(3, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('phs-retrieve/BORetriveAddExclusion').getValue(4, 1)</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>findTestData('phs-retrieve/BORetriveAddExclusion').getValue(5, 1)</defaultValue>
      <description></description>
